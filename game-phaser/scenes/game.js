...
//lo primero que hacemos es importar las clases creadas anteriormente que queremos añadir al juego, como la de vidas y la de los niveles 
...
export class Game extends Phaser.Scene {
  ...
  //aquí cargamos todas las imágenes y sonidos de audio
  preload() {
...
// y aquí creamos el juego completo metiendo los niveles, las fotos y los audios
  create() {
...
//y aquí actualizamos cada vez que pasa algo, por ejemplo cuando la pelota choca con un bloque o vuelve a la plataforma
...
//aqui tenemos el impacto con los bloques normales
...
// y aqui con los bloques fijos
  fixedBrickImpact(ball, brick) {
    this.fixedBrickImpactSample.play();
  }
//con esto incrementamos los puntos del usuario
  increasePoints(points) {
    this.score += points;
    this.scoreText.setText('PUNTOS: ' + this.score);
  }
// y aqui terminamos el juego
...
// y este último es para poner la bola y la plataformna en la psicion inicial.
